...
if (planetVisited == "false") {
  ...
  $("#find").html("Encuentra y haz clic en las cuatro herramientas del planeta para recopilar datos");
...
function toolsFound() {
  if (planetScore == 0) {
	...
	$("#find").html("Tres herramientas m&aacute;s para encontrar en este planeta");
  } else if (planetScore == 2) {
	$("#find").html("Dos herramientas m&aacute;s para encontrar en este planeta");
  } else if (planetScore == 3) {
	$("#find").html("Una herramienta m&aacute;s para encontrar en este planeta");
  } else {
	$("#find").html("Has encontrado todo en este planeta");
  }
}
